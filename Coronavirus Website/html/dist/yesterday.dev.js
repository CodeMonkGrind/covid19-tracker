              ...
              while (1) {
                switch (_context.prev = _context.next) {
                  case 0:
                    ...
                    url = "https://ncov2021.com/yesterday.json?v=" + Math.random();
                    _context.next = 4;
                  ...
                  case 7:
                    ...
                    for (i in world_list) {
                      ...
                      $("table tbody").append("\n        <tr>\n                  <td style=\"border-radius:3px\"><i class=\"flag-icon flag-icon-".concat(country.country_code, "\"></i>  ").concat(country.state || country.country, "</td>\n          <td style=\"color:var(--table-confblue);border-radius:3px\">").concat(country.confirmed.commaSplit(), "</td>\n          <td style=\"color:#02ff13;background-color:var(--table-confdark);border-radius:3px\">+ ").concat(country.daily_confirmed.commaSplit(), "</td>\n          <td style=\"color:#ea3344;border-radius:3px\">").concat(country.deaths.commaSplit(), "</td>\n          <td style=\"color:#ff073a;background-color:#020203;padding:12px 8px;border-radius:3px\">+ ").concat(country.daily_deaths.commaSplit(), "</td>\n          <td style=\"color:#6c757d;border-radius:3px\">").concat(country.critical.commaSplit(), "</td>\n          <td style=\"color:var(--yellowmod);border-radius:3px\">").concat(country.recovered.commaSplit(), "</td>\n          <td style=\"color:#6c757d;border-radius:3px\">").concat(country.population.commaSplit(), "</td>\n          <td style=\"color:#9673b9;border-radius:3px\">").concat(country.tests.commaSplit(), "</td>\n\n        </tr>\n        \n      "));
